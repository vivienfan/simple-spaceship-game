...
const gameState = {
  ...
  update: () => {
    game.physics.arcade.overlap(bullets, enemies, collisionHandler0, null, _this);
    game.physics.arcade.overlap(enemies, spaceship, collisionHandler1, null, _this);
...
const createEnemies = () => {
  ...
  tween.onRepeat.add(descend, _this);
};
